package FrameworkUtilities.GmailIntegration;

import FrameworkUtilities.ExtendReportIntegration.ExtentReporterNG;
...
public class SendingEmail extends ExtentReporterNG {
        ...
        System.out.println("Emailing test execution report ... ");
            ...
            try {
                ...
                message.setRecipients(Message.RecipientType.TO,InternetAddress.parse("syed.umair.sqa@gmail.com"));
